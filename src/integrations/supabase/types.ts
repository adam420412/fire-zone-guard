    ...
    Tables: {
      ...
      checklist_run_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "checklist_run_items_task_id_fkey"
            columns: ["task_id"]
            isOneToOne: false
      ...
      checklist_runs: {
        ...
        Relationships: [
          {
            foreignKeyName: "checklist_runs_building_id_fkey"
            columns: ["building_id"]
            isOneToOne: false
            referencedRelation: "building_cost_summary"
            referencedColumns: ["building_id"]
          ...
          {
            foreignKeyName: "checklist_runs_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      company_contact_buildings: {
        ...
        Relationships: [
          {
            foreignKeyName: "company_contact_buildings_building_id_fkey"
            columns: ["building_id"]
            isOneToOne: false
            referencedRelation: "building_cost_summary"
            referencedColumns: ["building_id"]
          ...
          {
            foreignKeyName: "company_contact_buildings_contact_id_fkey"
            columns: ["contact_id"]
            isOneToOne: false
